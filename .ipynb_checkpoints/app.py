...
def recommend(movie):
    ...
    movie_list = sorted(list(enumerate(distance)), reverse=True, key=lambda x: x[1])[1:21]
...
# Load data
movie_dict = pickle.load(open(r'C:\Users\shubh\Desktop\movie recommended system\movie_dict.pkl', 'rb'))
movies = pd.DataFrame(movie_dict)
similarity = pickle.load(open(r'C:\Users\shubh\Desktop\movie recommended system\similarity.pkl', 'rb'))
